...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_pvlnpjf",  // Replace with your EmailJS Service ID
        "template_2yedg6w",  // Replace with your EmailJS Template ID
        form.current,
        "d-HqzrUFdhJS1Ktv5"  // Replace with your EmailJS Public Key
      )
      .then(
        () => {
          setIsSent(true);
